    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          ...
          elevation: 0,
          title: Text(
            widget.isSelecting ? 'Adicionar ao Treino' : 'Biblioteca de Exercícios',
                  ...
                  return Container(
                    ...
                    child: ListTile(
                      ...
                      subtitle: Text(
                        ...
                        style: TextStyle(color: Theme.of(context).colorScheme.primary, fontSize: 11, fontWeight: FontWeight.bold, letterSpacing: 0.5),
                      ),
                      trailing: widget.isSelecting
                        ...
                        children: [
                          IconButton(
                            ...
                            onPressed: () {
                              _searchFocusNode.unfocus();
                              _showRoutineSelector(context, ex, provider);
                            },
                          ),
